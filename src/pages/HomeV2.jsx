...
/**
 * HomeV2 - Design premium detailing avec logo
 * Style Porsche avec images parallax qui s'entrecroisent
 * Videos en format 2/3
 */
const HomeV2 = () => {
        ...
        <div className={`grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-10 lg:gap-16 items-center ${!isEven ? 'lg:flex-row-reverse' : ''}`}>
          ...
          >
            <div className="relative">
              ...
              {/* Container media avec bordure arrondie - aspect ratio 2/3 */}
              <div className="relative aspect-[3/2] rounded-2xl lg:rounded-3xl overflow-hidden shadow-2xl shadow-dark-900/20">
                {service.video ? (
                  <video
                    src={service.video}
                    autoPlay
